...
Feature: Smoke Tests
  ...
  Scenario: Create Order
    ...
    When the user selects the portal from the test data
    And the user clicks on eligibility
    ...
    And the user fills in the Stripe details from the card details
    Then the order should be created successfully

  Scenario: FAQ page
    Given the user is on the dashboard
    When the user opens the FAQ page
